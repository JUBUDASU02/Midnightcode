...
export default function ForgotPasswordPage() {
  return (
    <div className="bg-background-light dark:bg-background-dark text-slate-100 min-h-screen flex items-center justify-center p-0 md:p-6 font-display">
      ...
      <div className="absolute inset-0 flex items-center justify-center z-20 p-12">
        ...
        <div className="space-y-6">
          ...
          <p className="text-slate-300 text-xl max-w-md font-light leading-relaxed">
            Reconnect with the rhythm. Reset your access to the city's most
            exclusive beats.
          </p>
  ...
  return (
    <main className="flex-1 flex flex-col justify-center max-w-md mx-auto w-full">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        ...
        <button
          type="submit"
          className="w-full bg-primary hover:bg-primary/90 text-white font-bold py-4 rounded-xl shadow-lg transition-all active:scale-[0.98] flex items-center justify-center gap-2"
        >
  ...
  return (
    <div className="space-y-2">
      ...
      <div className="relative group">
        ...
        <span className="material-symbols-outlined absolute left-4 top-1/2 -translate-y-1/2 text-slate-500 group-focus-within:text-primary">
          mail
        </span>
        ...
        <input
          ...
          className="w-full bg-primary/5 border border-primary/20 rounded-xl py-4 pl-12 pr-4 text-slate-100 placeholder:text-slate-600 focus:outline-none focus:ring-2 focus:ring-primary/50"
        />
...
function HelpBox() {
  return (
    <div className="mt-12 p-6 rounded-xl bg-primary/5 backdrop-blur border border-primary/20">
      ...
      <div className="flex items-start gap-4">
        ...
        <p className="text-sm text-slate-400 leading-relaxed">
          If you don't see the email in your inbox within 5 minutes,
          check your spam folder or contact our concierge support.
        </p>
