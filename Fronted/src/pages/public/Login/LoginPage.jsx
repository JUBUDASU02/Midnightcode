      ...
      <div className="flex-1 flex flex-col items-center justify-center p-6 sm:p-12 lg:p-24 relative bg-background-light dark:bg-background-dark">
        ...
        <div className="w-full max-w-md glass-panel p-8 sm:p-10 rounded-xl shadow-2xl">
          ...
          {GOOGLE_CLIENT_ID ? (
            ...
            <div className="flex items-center justify-center gap-3 w-full py-3.5 rounded-lg border border-white/10 bg-white/5 text-slate-400 text-sm cursor-not-allowed opacity-50">
              ...
              Continuar con Google (configura VITE_GOOGLE_CLIENT_ID)
            </div>
          )}
