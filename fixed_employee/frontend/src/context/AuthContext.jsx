...
// ─── MOCK USERS ──────────────────────────────────────────────────────────────
// Reemplazar por POST /api/auth/login cuando conectes el backend
const MOCK_USERS = [
  {
    id: 1,
    name: "Alex Rivera",
  ...
  // ✅ BUG-02 FIX: usuario DJ — ruta /dj ahora es accesible
  {
    id: 3,
    name: "DJ Jubu",
    email: "dj@neon.com",
  ...
  // Empleado — portal de ventas, productos, horario y ayuda
  {
    id: 4,
    name: "Valentina Ríos",
    email: "empleado@neon.com",
...
export function AuthProvider({ children }) {
  ...
  const register = useCallback(({ name, email, password }) => {
    ...
    const newUser = {
      ...
      memberSince: new Date().toLocaleDateString("es-CO", {
        month: "long",
        year: "numeric",
      }),
    };
